...
function setup() 
{
  ...
  ground = new Ground(315,height,width,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;
...
star1 = createSprite(275,75,35,35)
...
star2 = createSprite(60,375,35,35)
  star2.addImage(star_img)
star2.scale = 0.025

blower = createImg("baloon2.png")
blower.size(100,100)
blower.position(275,375)
